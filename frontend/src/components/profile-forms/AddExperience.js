    ...
    <Fragment>
      ...
      <form class="form" onSubmit={e => onSubmit(e)}>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          <p><input type="checkbox" name="current" check={current} value={current} onChange={e => {setFormData({ ...formData, current: !current }); toggleDisabled(!toDateDisabled)}}/> Current Job</p>
        </div>
        <div class="form-group">
          <h4>To Date</h4>
